pipeline {
  ...
  environment {
    ...
    LS_REPO = 'docker-xvfb'
    CONTAINER_NAME = 'xvfb'
    DOCKERHUB_IMAGE = 'linuxserver/xvfb'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/xvfb'
    PR_DOCKERHUB_IMAGE = 'lspipepr/xvfb'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH='true'
    CI='false'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-xvfb/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-xvfb\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-xvfb\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Xvfb\" \
          --label \"org.opencontainers.image.description=xvfb image by linuxserver.io\" \
      ...
      steps {
        sh '''#! /bin/bash
              ...
              jq -n \
                ...
                --arg target_commitish "debianbookworm" \
                ...
                '{
                  ...
                  "body": ("**CI Report:**\\n\\n" + $ci_url + "\\n\\n**LinuxServer Changes:**\\n\\n" + $ls_notes + "\\n\\n**Remote Changes:**\\n\\n" + $remote_notes),
                  "draft": false,
                  "prerelease":                 }' > releasebody.json.done
